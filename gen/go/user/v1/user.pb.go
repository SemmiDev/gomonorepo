// user/v1/user.proto
//
// Ini adalah "kontrak" antara semua service yang berinteraksi dengan User.
// Filosofi penting: .proto files adalah SOURCE OF TRUTH untuk API kamu.
// Dari satu file ini, Buf akan generate:
//   - Go structs (untuk serialisasi/deserialisasi)
//   - gRPC server interface (untuk user-svc mengimplementasikan)
//   - gRPC client interface (untuk order-svc memanggil user-svc)
//
// Dengan pendekatan ini, TYPE SAFETY terjamin di seluruh service!
...
type User struct {
	...
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"` // UUID string, bukan int agar aman di distributed system
	Name          string                 `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	Email         string                 `protobuf:"bytes,3,opt,name=email,proto3" json:"email,omitempty"`
	Role          string                 `protobuf:"bytes,4,opt,name=role,proto3" json:"role,omitempty"`                             // "admin", "customer", dll.
...
type ListUsersResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Users         []*User                `protobuf:"bytes,1,rep,name=users,proto3" json:"users,omitempty"` // "repeated" = slice di Go
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_user_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x12user/v1/user.proto\x12\auser.v1\"s\n" +
	"\x04User\x12\x0e\n" +
	...
	"\x04user\x18\x01 \x01(\v2\r.user.v1.UserR\x04user2\xd6\x01\n" +
	"\vUserService\x12<\n" +
	...
	"\n" +
	"CreateUser\x12\x1a.user.v1.CreateUserRequest\x1a\x1b.user.v1.CreateUserResponseB6Z4github.com/semmidev/gomonorepo/gen/go/user/v1;userv1b\x06proto3"
...
var file_user_v1_user_proto_depIdxs = []int32{
	...
	6, // 8: user.v1.UserService.CreateUser:output_type -> user.v1.CreateUserResponse
